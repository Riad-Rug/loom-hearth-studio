...
function createLaunchOrderConfirmationMessage(input: {
  ...
  return {
    ...
    html: [
      ...
      "<p>Launch shipping is fixed at $0.00 for the USA, Europe, Canada, and Australia. Destination and delivery conditions are confirmed before payment is captured.</p>",
    ...
    text: [
      ...
      "",
      "Launch shipping is fixed at $0.00 for the USA, Europe, Canada, and Australia. Destination and delivery conditions are confirmed before payment is captured.",
