...
function createLaunchOrderConfirmationMessage(input: {
  ...
  return {
    ...
    html: [
      ...
      "<p>Shipping to the United States is free on orders of $150 or more; orders under $150 ship for a flat $50, included in your total above. Inquiries from other countries are reviewed case by case before payment is captured.</p>",
    ...
    text: [
      ...
      "",
      "Shipping to the United States is free on orders of $150 or more; orders under $150 ship for a flat $50, included in your total above. Inquiries from other countries are reviewed case by case before payment is captured.",
