...
function createLaunchOrderConfirmationMessage(input: {
  ...
  return {
    ...
    html: [
      ...
      "<p>Launch shipping is fixed at $0.00 for the United States, Canada, Australia, and United Kingdom. Inquiries from other countries are reviewed case by case before payment is captured.</p>",
    ...
    text: [
      ...
      "",
      "Launch shipping is fixed at $0.00 for the United States, Canada, Australia, and United Kingdom. Inquiries from other countries are reviewed case by case before payment is captured.",
