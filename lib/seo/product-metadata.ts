...
export function buildProductMetaDescription(product: ProductDetailPageViewModel) {
  ...
  return `ONE OF A KIND Moroccan ${productLabel}${dimensions}, ${product.priceUsdLabel} USD. Ships from Morocco in 7-14 business days, 14-day returns. Exact-piece photos before payment.`;
}
