...
export function buildProductMetaDescription(product: ProductDetailPageViewModel) {
  ...
  return `ONE OF A KIND Moroccan ${productLabel}${dimensions}, ${product.priceUsdLabel} USD. Ships from Morocco in 5-7 business days, duties included to US/CA/AU, 14-day returns. Exact-piece video before payment.`;
}
